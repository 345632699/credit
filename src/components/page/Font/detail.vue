            ...
            <el-row>
                <el-col v-if="displayDesc" :lg="16" :md="24">
                    ...
                    <div class="main" v-else
                        ...
                        <div class="re-list">
                            <div id="jp-relatedposts" class="jp-relatedposts"
                                 style="display: block;text-align: left;border-top: 1px solid #d8d8d8;">
                                <h3 class="jp-relatedposts-headline">
                                    <em>相关</em>
                                </h3>
                                <el-row type="flex" justify="space-around"
                ...
                <el-col :lg="8" :md="24">
                        ...
                        <div class="main">
                            <ul class="smart-post-list-main">
                                <li class="smart-post-list-single-container" style="width: 100%; clear: right;"
                                    ...
                                    <div class="image-left-of-excerpt img-container"
                    ...
                    <div class="in-search" style="clear: both;margin-top: 470px;padding-top: 1px;height: 260px">
                        ...
                        <div class="box">
                            <img style="text-align: center;margin: auto" width="40%" src="@/assets/img/qrcode.png"
                                 alt="">
                        </div>
                    </div>
                </el-col>
...
export default {
  ...
  methods: {
    ...
    getDetail (id) {
      let articleId = id
      this.activeIndex2 = this.$route.query.activeIndex2
      this.loading = true
      this.currentArticleId = articleId
      api.article(articleId, (d) => {
