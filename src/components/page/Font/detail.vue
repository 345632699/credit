			...
			<div class="header">
				<el-row>
					<el-col class="logo" :span="18">
						<img width="40%" src="@/assets/img/bg.png" alt="">
					</el-col>
					<el-col :span="6">
						<el-input
								class="search"
				...
				<el-col v-if="displayDesc" :lg="16" :md="24">
					<div class="article-content">
						...
						<div class="main">
							...
							<div class="bg-img">
								<img :src="'http://148.72.64.80/cgi-bin/download.pl?proj=credit&fid=' + articleInfo.coverFid" alt="">
							</div>
				...
				<el-col v-else :lg="16" :md="24" style="min-height: 800px;">
					<div v-if="article_list.length > 0" class="article-item" v-for="(item,index) in article_list" :key="index">
						...
						<div class="flex">
							...
							<div class="footer">
								<div class="menu">{{ item.ownershipMenuName }}</div>
...
export default {
  ...
  methods: {
    ...
    readMore (id) {
      this.$router.push({ name: 'frontDetail', params: { id: id } })
      // this.loading = true
      // api.article(id, (d) => {
