var APIConnection = function () {
  ...
  this.send_obj = function (a) {
    ...
    if (this.last_req !=
            null && this.user_pref.single_request_only == 'true') return this.clog('send: last_req not null, new request is ignored'), !1
  ...
  this.connect = function () {
    if (this.conn_state == 'CONNECTING_1' || this.conn_state == 'CONNECTING_2' ||
            this.conn_state == 'CONNECTING_3' || this.conn_state == 'CONNECTING_4' || this.conn_state == 'CONNECTING_5') this.clog('connect: already connecting, connect request is ignored')
    else {
